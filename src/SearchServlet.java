...
public class SearchServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (searchFilter.equals("Search Name")) {
			...
			out.print("<body>");
			out.print(
					"<div class=\"d-flex justify-content-between p-2 bg-light mb-3 \"> <a href=\"search.html\">Back</a></div>\r\n"
			...
			// \"><a class=\"\" href=\"search.html\">Back</a><a
...
//	    			result.addElement(item);;
			...
			out.print("<body>");
			out.print(
					"<div class=\"d-flex justify-content-between p-2 bg-light mb-3 \"> <a href=\"index.html\">Back</a></div>\r\n"
							+ " <form  action=\"search_servlet\" method=\"POST\">\r\n"
							+ "   <div class=\"d-flex flex-row pt-5 justify-content-center align-items-center\" >\r\n"
							+ "     <input autofocus class=\"mr-3\" type=\"text\" name=\"name\" placeholder=\"Search name\" />\r\n"
							+ "     \r\n" + "      <input   type=\"submit\" value=\"Search\" />\r\n" + "   </div>");
...
//	    			result.addElement(item);;
					...
					// out.print("<h5 class=\"card-header bg-info text-white\">" + item.getName() +
					// "</h5>");
					out.print("<div class=\"card-body\"><p class=\"card-text\">" + "  " + item.getMessage() + "</p>");
					// out.print("<p class=\"card-text\"><small
					// class=\"text-muted\">"+dateFormat.format(item.getDate())+"</small></p>\r\n"+
					// "</div>");
					out.print("</div>");
